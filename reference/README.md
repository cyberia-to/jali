...
one R_q multiply = 3n F_p multiplies (via NTT). the 3072× gap (at n=1024) over scalar nebu arithmetic justifies a dedicated algebra — same criterion that separates kuro (32× gap for binary).

## modules

| module | spec | role |
|--------|------|------|
| [[ring]] | [[ring]] | R_q element type, add, sub, mul, automorphisms |
| [[ntt]] | [[ntt]] | ring ↔ NTT domain transforms (uses nebu NTT internally) |
| [[noise]] | [[noise]] | noise tracking, bounds, growth estimation |
| [[sample]] | [[sample]] | error distributions, small secret generation |
...
|----------|-------------|-----|
| mudra::seal | R_q for Module-RLWE key encapsulation | polynomial matrix × vector + noise |
